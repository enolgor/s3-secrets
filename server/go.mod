module github.com/enolgor/s3-secrets/server
...
require (
	...
	github.com/enolgor/go-utils/lambda v1.2.2
	github.com/enolgor/go-utils/server v1.2.2
...
require (
	...
	github.com/enolgor/go-utils/client v1.2.2 // indirect
)
